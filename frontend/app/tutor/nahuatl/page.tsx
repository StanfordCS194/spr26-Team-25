...
export default function NahuatlPage() {
  ...
  useEffect(() => {
    // request a nahuatl-mode token — this dispatches eirini with metadata="nahuatl"
    // which tells run_eirini in agent.py to use NahuatlTTS and NAHUATL_SYSTEM_PROMPT
    // fetch(`${process.env.NEXT_PUBLIC_API_URL ?? 'http://localhost:8000'}/api/livekit-token-nahuatl`)
    fetch('https://spr26-team-25-production.up.railway.app/api/livekit-token-nahuatl')
      .then(res => res.json())
      .then(data => setTokenData(data))
      .catch(() => setError('Could not connect to Citlali. Please try again.'));
  }, []);
